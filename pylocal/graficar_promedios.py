...
month_names = {'jan': 'Enero', 'feb': 'Febrero', 'mar': 'Marzo', 'apr': 'Abril', 'may': 'Mayo', 'jun': 'Junio', 'jul': 'Julio', 'aug': 'Agosto', 'sep': 'Septiembre', 'oct':'Octubre', 'nov':'Noviembre', 'dic': 'Diciembre'}
...
for mm in sys.argv: #La lista de argumentos contiene los nombres de los archivos a convertir. Para todos los archivos has esto:
    ...
    plt.title(month_names[mm] + ' 2015', fontsize = 15)

    plt.savefig(path_month_graficas + 'MP_' + mm + '_Raw_PBLH_24_' + location, facecolor=(1,1,1,0))
    ...
    plt.ylim((-100,3500))
    plt.xticks(range(0,25,4))
    plt.title(month_names[mm] + ' 2015')
    plt.savefig(path_month_graficas + 'MP_' + mm + '_Raw_mean_PBLH_24_'+location, edgecolor='w', facecolor=(1,1,1,0))
    ...
    plt.xticks(range(0,25,4))
    plt.title(month_names[mm] + ' 2015')
    plt.savefig(path_month_graficas + 'MP_' + mm + '_Raw_PBLH_48_' + location, facecolor=(1,1,1,0))
    ...
    plt.xticks(range(0,25,4))
    plt.title(month_names[mm] + ' 2015')
    plt.savefig(path_month_graficas + 'MP_' + mm + '_Raw_mean_PBLH_48_' + location, facecolor=(1,1,1,0))
