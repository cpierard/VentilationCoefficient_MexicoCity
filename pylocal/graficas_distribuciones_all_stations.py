...
for loc in locations:
    ...
    ALL.to_csv(path2DataFrames + '/vc_ALL.csv', float_format='%.2f')#, na_rep='nan')
...
k = sorted(day_ALL.loc[day_ALL.O3 > 95]['u_mean'].dropna())
l = sorted(day_ALL.loc[day_ALL.O3 < 95]['u_mean'].dropna())
...
ax1.hist(day_ALL.loc[day_ALL.O3 < 95]['pblh'],density = True, alpha = 0.4, color = color_2, bins = 15)
ax1.hist(day_ALL.loc[day_ALL.O3 > 95]['pblh'],density = True, alpha = 0.4, color = color_1, bins = 15)
...
ax3.scatter(day_ALL.loc[day_ALL.O3 < nom_o3]['pblh'], day_ALL.loc[day_ALL.O3 < nom_o3]['u_mean'],
...
ax4.hist(day_ALL.loc[day_ALL.O3 < 95]['u_mean'],density = True, alpha = 0.4, color = color_2, bins = 20,
         orientation = "horizontal")
ax4.hist(day_ALL.loc[day_ALL.O3 > 95]['u_mean'],density = True, alpha = 0.4, color = color_1, bins = 20,
        orientation = "horizontal")
...
ax1 = fig.add_subplot(gs[0])
ax1.hist(day_ALL.loc[day_ALL['PM2.5'] < nom_pm25]['pblh'],density = True, alpha = 0.4, color = color_2, bins = 15)
ax1.hist(day_ALL.loc[day_ALL['PM2.5'] > nom_pm25]['pblh'],density = True, alpha = 0.4, color = color_1, bins = 15)
ax1.plot(h,fit_h, c = color_1, linewidth=2)
ax1.plot(j,fit_j, c = color_2, linewidth=2)
ax1.set_axis_off()
...
ax3.scatter(day_ALL.loc[day_ALL['PM2.5'] < nom_pm25]['pblh'], day_ALL.loc[day_ALL['PM2.5'] < nom_pm25]['u_mean'],
...
ax4 = fig.add_subplot(gs[3])
ax4.hist(day_ALL.loc[day_ALL['PM2.5'] < nom_pm25]['u_mean'],density = True, alpha = 0.4, color = color_2, bins = 20,
         orientation = "horizontal")
ax4.hist(day_ALL.loc[day_ALL['PM2.5'] > nom_pm25]['u_mean'],density = True, alpha = 0.4, color = color_1, bins = 20,
        orientation = "horizontal")
ax4.plot(fit_k, k, c = color_1, linewidth=2)
ax4.plot(fit_l, l, c = color_2, linewidth=2)
ax4.set_axis_off()
...
ax1 = fig.add_subplot(gs[0])
ax1.hist(day_ALL.loc[day_ALL['PM10'] < nom_pm10]['pblh'],density = True, alpha = 0.4, color = color_2, bins = 15)
ax1.hist(day_ALL.loc[day_ALL['PM10'] > nom_pm10]['pblh'],density = True, alpha = 0.4, color = color_1, bins = 15)
ax1.plot(h,fit_h, c = color_1, linewidth=2)
ax1.plot(j,fit_j, c = color_2, linewidth=2)
ax1.set_axis_off()
...
#CS = ax3.contour(xi,yi,VC_grid, colors='k', levels=[3000, 6000, 9000, 12000, 15000, 18000, 21000, 24000],alpha = 0.7)
#ax3.clabel(CS, fontsize=9, inline=1, fmt = '%1.0f')
ax3.scatter(day_ALL.loc[day_ALL['PM10'] < nom_pm10]['pblh'], day_ALL.loc[day_ALL['PM10'] < nom_pm10]['u_mean'],
...
ax4 = fig.add_subplot(gs[3])
ax4.hist(day_ALL.loc[day_ALL['PM10'] < nom_pm10]['u_mean'],density = True, alpha = 0.4, color = color_2, bins = 20,
         orientation = "horizontal")
ax4.hist(day_ALL.loc[day_ALL['PM10'] > nom_pm10]['u_mean'],density = True, alpha = 0.4, color = color_1, bins = 20,
        orientation = "horizontal")
ax4.plot(fit_k, k, c = color_1, linewidth=2)
ax4.plot(fit_l, l, c = color_2, linewidth=2)
ax4.set_axis_off()
